            ...
            <div className="container mx-auto py-16 px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="footer-item">
                        ...
                        <Link href="/products/cctv-systems" className="text-gray-400 hover:text-blue-500 mb-2 block">CCTV Systems</Link>
                        <Link href="/products/solar-shop" className="text-gray-400 hover:text-blue-500 mb-2 block">Solar Energy</Link>
                    ...
                    <div className="footer-item">
                        ...
                        <p className="text-gray-400 mb-2">7 Cedar Complex, Ibadan, Nigeria</p>
                        <p className="text-gray-400 mb-2">+234 814 211 1657</p>
